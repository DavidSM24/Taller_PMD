...
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! date-fns */ 7366);
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! date-fns */ 2498);
...
let CarRepairUpdatePage = class CarRepairUpdatePage {
    ...
    constructor(modalController, carRepairService, formBuilder, activateRoute, uts) {
    ...
    ngOnInit() {
        ...
        this.formCarRepair = this.formBuilder.group({
            ...
            clienteName: [this.carRepair.clienteName, [_angular_forms__WEBPACK_IMPORTED_MODULE_4__.Validators.required]],
    ...
    dateFormat() {
        let date = this.formCarRepair.get("dateOrder").value;
        console.log();
    }
    confirm() {
    ...
    formatDate(value) {
        return (0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])(value), 'yyyy-MM-dd HH:mm:SS');
    }
    change(event) {
        console.log(event);
...
CarRepairUpdatePage = (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([
...
module.exports = ".body {\n  background: #717499;\n  background-size: cover;\n  min-height: 100%;\n}\n\n.formulario {\n  margin-top: 1.5%;\n  padding: 2%;\n  border-top: 2px double gray;\n  border: 1px solid;\n  border-color: \"primary\";\n  border-radius: 2.5rem;\n  background-color: white;\n  margin-bottom: 4%;\n}\n\n.button {\n  --background: #22388c;\n}\n\n.customInput {\n  border: 1px solid gray;\n  border-color: \"primary\";\n  border-radius: 2.5rem;\n}\n\n.secundaryInput {\n  margin-left: 5%;\n}\n\n.date {\n  margin-left: 20%;\n}\n\n.buttonDate {\n  background-color: #717499;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
