...
const routes = [
    {
        ...
        children: [
            {
                path: 'gift-create',
                loadChildren: () => __webpack_require__.e(/*! import() */ "common").then(__webpack_require__.bind(__webpack_require__, /*! ../gif-create/gif-create.module */ 4844)).then(m => m.GifCreatePageModule)
            },
            {
                path: 'gift-saw',
...
GifListPageModule = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([
